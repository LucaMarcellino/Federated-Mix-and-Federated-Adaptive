...
if __name__ == '__main__':
    ...
    train_csv.to_csv(f'FedMix_5_local_ep_iid:{args.iid}_lr:{args.lr}_mom:{args.momentum}_epochs:{args.epochs}_alphaB:{args.alpha_b}_alphaG:{args.alpha_g}.csv', index = False)