...
dataMix1000 = pd.read_csv("Results\FedADP_results\FedMix_5_local_ep_iid_1_unbalanced_0_lr_0.01_mom_0.5_epochs_50_alphaB_1.0_alphaG_0.0.csv")
...
plt.plot(dataMix1000["Epochs"],dataMix1000["Test accuracy"],marker = "o",markersize=3.5, label = 'FedMix IID alpha_b=1.0 alpha_g=0.0')
plt.ylim(bottom = 0)
...
dataMix1000 = pd.read_csv("Results\FedADP_results\FedMix_5_local_ep_iid_0_unbalanced_0_lr_0.01_mom_0.5_epochs_50_alphaB_1.0_alphaG_0.0.csv")
...
plt.plot(dataMix1000["Epochs"],dataMix1000["Test accuracy"],marker = "o",markersize=3.5, label = 'FedMix NonIID alpha_b=1.0 alpha_g=0.0')
plt.ylim(bottom = 0)
...
plt.grid()
plt.legend(loc="lower right")
plt.savefig("Images/Comparison between methods with NonIID in FedAdp settings.png")
plt.show()
...
plt.grid()
plt.legend(loc="lower right")
plt.savefig("Images/Comparison between methods with IID in FedMix setting.png")
plt.show()
...
plt.grid()
plt.legend(loc="lower right")
plt.savefig("Images/Comparison between methods with IID in FedGKT setting 128 l_bs.png")
plt.show()
...
plt.grid()
plt.legend(loc="lower right")
plt.savefig("Images/Comparison between methods with IID in FedGKT setting 16 l_bs.png")
plt.show()
...
plt.grid()
plt.legend(loc="lower right")
plt.savefig("Images/Comparison between methods with NonIID Unbalanced in FedMix settings.png")
plt.show()
...
plt.grid()
plt.legend(loc="lower right")
plt.savefig("Images/Comparison between methods with NonIID Unbalanced in FedGKT setting 128 l_bs.png")
plt.show()
...
plt.plot(dataMix0010["Epochs"],dataMix0010["Test accuracy"],marker = "o",markersize=3.5, label = 'FedMix Non-IID unbalanced alpha_b=0.0 alpha_g=1.0')
